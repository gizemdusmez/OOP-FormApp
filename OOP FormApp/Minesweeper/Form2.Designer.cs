namespace ProjektProgram
{
    partial class Form2
    {
        ...
        /// </summary>
        /// <param name="disposing">Eğer true ise, yönetilen bileşenler ve kaynaklar serbest bırakılır; 
        /// false ise yalnızca yönetilmeyen (native) kaynaklar serbest bırakılır.</param>
